...
extern "C" {
#endif
SWIGINTERN int Swig_var_ENFORCE_INDEPENDENT_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable ENFORCE_INDEPENDENT is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_ENFORCE_INDEPENDENT_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_int(static_cast< int >(ENFORCE_INDEPENDENT));
  return pyobj;
}


SWIGINTERN int Swig_var_ENFORCE_ALIGNED_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable ENFORCE_ALIGNED is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_ENFORCE_ALIGNED_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_int(static_cast< int >(ENFORCE_ALIGNED));
  return pyobj;
}


SWIGINTERN int Swig_var_REBOUND_BORDER_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable REBOUND_BORDER is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_REBOUND_BORDER_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_int(static_cast< int >(REBOUND_BORDER));
  return pyobj;
}


SWIGINTERN int Swig_var_REBOUND_INTERIOR_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable REBOUND_INTERIOR is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_REBOUND_INTERIOR_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_int(static_cast< int >(REBOUND_INTERIOR));
  return pyobj;
}
...
SWIGINTERN int SWIG_mod_exec(PyObject *m) {
  ...
  SWIG_addvarlink(globals, "ENFORCE_INDEPENDENT", Swig_var_ENFORCE_INDEPENDENT_get, Swig_var_ENFORCE_INDEPENDENT_set);
  SWIG_addvarlink(globals, "ENFORCE_ALIGNED", Swig_var_ENFORCE_ALIGNED_get, Swig_var_ENFORCE_ALIGNED_set);
  SWIG_addvarlink(globals, "REBOUND_BORDER", Swig_var_REBOUND_BORDER_get, Swig_var_REBOUND_BORDER_set);
  SWIG_addvarlink(globals, "REBOUND_INTERIOR", Swig_var_REBOUND_INTERIOR_get, Swig_var_REBOUND_INTERIOR_set);
  return 0;
}
